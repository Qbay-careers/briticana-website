...
| **Course / product card**  | Image, meta, price, CTA                              | Home, all `courses*`                | `single-courses`, `card`, rows/cols           | Owl in carousels; hover CSS         | `**InternshipCard`** / `CourseCard`                     | `title`, `image`, `href`, `badges[]`, `meta`                                                                              |
